...
<div class="vrc-order-details-costs-wrap">
	<div class="vrc-order-details-costs-inner">
		...
		<div class="vrc-order-details-costs-row">
			<span class="vrc-order-details-costs-name vrc-order-details-costs-rplan-name"><?php echo JText::_('VRLIBSIXTVA') ?></span> 
			<span class="vrc-order-details-costs-price">
				<span class="vrc_price"><?php echo VikRentCar::numberFormat($car_cost*(19/100)); ?></span>
				<span class="vrc_currency">EUR</span> 
			</span>
		</div>
		<?php
		...
		<div class="vrc-order-details-costs-row vrc-order-details-costs-row-total">
			<span class="vrc-order-details-costs-name"><?php echo JText::_('VRLIBSIXCUTVA'); ?></span> 
			<span class="vrc-order-details-costs-price">
				<span class="vrc_price vrc_keepcost"><?php echo VikRentCar::numberFormat($ord['order_total'] + ($ord['order_total']*(19/100))); ?></span>
				<span class="vrc_currency vrc_keepcost">EUR</span> 
			</span>
		</div>
	<?php
	if ($ord['totpaid'] > 0 && !($ord['totpaid'] > $ord['order_total'])) {
		...
		<div class="vrc-order-details-costs-row vrc-order-details-costs-row-total vrc-order-details-costs-row-totalpaid">
			...
			<span class="vrc-order-details-costs-price">
				<span class="vrc_price vrc_keepcost"><?php echo VikRentCar::numberFormat($ord['totpaid'] + ($ord['totpaid']*(19/100))); ?></span>
				<span class="vrc_currency vrc_keepcost">EUR</span> 
			</span>
		</div>
		<?php
	...
	if ($printer == 1) {
		...
		if (is_file(VRC_SITE_PATH . DIRECTORY_SEPARATOR . "resources" . DIRECTORY_SEPARATOR . "pdfs" . DIRECTORY_SEPARATOR . $ord['id'] . '_' . $ord['ts'] . '.pdf')) {
			...
			<p class="vrcdownloadpdf">
				<a href="<?php echo VRC_SITE_URI; ?>resources/pdfs/<?php echo $ord['id'].'_'.$ord['ts']; ?>.pdf" target="_blank"><?php VikRentCarIcons::e('file-pdf'); ?> <?php echo JText::_('VRCDOWNLOADPDF'); ?></a>
			</p>
			<?php
		}
