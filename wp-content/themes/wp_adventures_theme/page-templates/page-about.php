...
if($show_page_name) { ?>
<div class="alert-danger"><?php echo "page-about.php"; ?></div>
<?php } ?>
...
<?php if ( is_active_sidebar( 'aboutus-bottom' ) ) { ?>
	<?php get_template_part( 'template-parts/modules/aboutus-bottom', '' ); ?>
<?php } ?>
<?php if ( is_active_sidebar( 'fullbox-page' ) ) { ?>
	<?php get_template_part( 'template-parts/modules/fullbox', 'page' ); ?>
<?php } ?>
