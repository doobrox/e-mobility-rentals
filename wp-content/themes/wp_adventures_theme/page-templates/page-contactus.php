...
if($show_page_name) { ?>
<div class="alert-danger"><?php echo "page-contactus.php"; ?></div>
<?php } ?>
	...
	<div id="cnt-container">
		<div class="main-box grid-block">
			<section class="main grid-box">
				<div class="main-body page-contactus">
					<?php
					// Start the loop.
...
<?php if ( is_active_sidebar( 'modulebox-contact' ) ) { ?>
	<?php get_template_part( 'template-parts/modules/modulebox', 'contact' ); ?>
<?php } ?>
