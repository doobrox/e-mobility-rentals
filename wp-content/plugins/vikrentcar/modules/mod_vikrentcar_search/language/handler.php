        ...
        if(pll_current_language() == 'en'){
            switch ($string)
            {
                ...
                case 'MOD_VIKRENTCAR_SEARCH_DESC':
                    $result = __('Search Form to start booking vehicles.', 'vikrentcar');
                    break;
                case 'TITLE':
                ...
                case 'USEGLOB':
                    ...
                    break;
                case 'SEARCHT':
                    $result = __('See Options', 'vikrentcar');
                    break;
                case 'SEARCHHELP':
                ...
                case 'FORCESINGLECATEGORYSEARCHHELP':
                    $result = __('If enabled, the search module will check the availability only for the vehicles assigned to this specific category.', 'vikrentcar');
                    break;
            ...
            switch ($string)
            {
                ...
                case 'USEGLOB':
                    ...
                    break;
                case 'SEARCHT':
                    $result = __('Vezi Optiunile', 'vikrentcar');
                    break;
                case 'SEARCHHELP':
                    $result = __('Custom Search Button Text, Leave empty to use default value', 'vikrentcar');
                    break;
