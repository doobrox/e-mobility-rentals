...
?>
<div class="vrc-search-results-block test1">
...
foreach ($cars as $c) {
	...
	<div class="car_result">
		<div class="vrc-car-result-left test1">
		<?php
		if (!empty($c['img'])) {
			...
			?>
				<a href="<?php echo JRoute::rewrite('index.php?option=com_vikrentcar&view=cardetails&carid='.$c['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>">
		...
		<div class="vrc-car-result-right">
			<div class="vrc-car-result-rightinner">
				<div class="vrc-car-result-rightinner-deep">
					...
					if (strlen($vcategory)) {
						?>
						<div class="vrc-car-category test1"><?php echo $vcategory; ?></div>
						<?php
					}
					?>
					...
					<div class="vrc-car-lastblock">
						<div class="vrc-car-price">
							...
							?>
								...
								<span class="car_cost"><span class="vrc_currency">EUR pe zi</span> <span class="vrc_price"><?php echo strlen($c['startfrom']) > 0 ? VikRentCar::numberFormat($c['startfrom']) : VikRentCar::numberFormat($c['cost']); ?></span></span>
							<?php
							}
							?>
							</div>
						...
						<div class="vrc-car-bookingbtn">
							<span class="vrclistgoon"><a class="btn vrc-pref-color-btn" href="<?php echo JRoute::rewrite('index.php?option=com_vikrentcar&view=cardetails&carid='.$c['id'].(!empty($pitemid) ? '&Itemid='.$pitemid : '')); ?>">
								<?php echo JText::translate('VRCLISTPICK'); ?>
							</a></span>
						</div>
					</div>
				</div>
