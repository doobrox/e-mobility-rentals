...
<div class="vrc-emailc-wrap" style="max-width: 642px; background: #fff; border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; border-left: 1px solid #ddd; border-right: 1px solid #ddd; margin: 0 auto; padding: 24px;">
	...
	<div class="vrc-emailc-logo" style="text-align: center; margin: 8px 0;"><img height="50px" src="https://e-mobility-rentals.com/wp-content/uploads/2022/09/Logo_Mobility_Rentals-new.png" alt=""></div>

	<div class="container" style="font-family: 'Century Gothic', Tahoma, Arial;">
		<p class="Stile1" style="font-size: 18px; font-weight: bold;">E Mobility Rentals - Cerere rezervare</p>
		...
		<div class="hiremainbox">
			...
			<div class="hireorderdetail" style="margin-top: 15px;">
				...
				<!-- {order_details} -->
				<div class="hireordata hiretotal" style="margin:0 0 7px 0; margin: 10px 0 7px 0; color: #144D5C; border-top: 1px solid #ddd; padding: 10px 0 0 0; font-size: 16px; font-weight: bold;"><span><?php echo JText::translate('VRLIBSIXFARATVA'); ?></span><div style="float:right;"><strong><?php echo (number_format($order_details['car_cost'], 2)); ?> EUR</strong></div></div>
				<div class="hireordata hiretotal" style="margin:0 0 7px 0; margin: 10px 0 7px 0; color: #144D5C; border-top: 1px solid #ddd; padding: 10px 0 0 0; font-size: 16px; font-weight: bold;"><span><?php echo JText::translate('VRLIBSIXTVA'); ?></span><div style="float:right;"><strong><?php echo (number_format($order_details['car_cost']*(19/100), 2)); ?> EUR</strong></div></div>
				<div class="hireordata hiretotal" style="margin:0 0 7px 0; margin: 10px 0 7px 0; color: #144D5C; border-top: 1px solid #ddd; padding: 10px 0 0 0; font-size: 16px; font-weight: bold;"><span><?php echo JText::translate('VRLIBSIXCUTVA'); ?></span><div style="float:right;"><strong><?php echo (number_format($order_details['car_cost'] + ($order_details['car_cost']*(19/100)), 2)); ?> EUR</strong></div></div>
				{order_deposit}
				{order_total_paid}
			</div>
